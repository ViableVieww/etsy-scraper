  ...
  for (const term of keyTerms) {
    ...
    while(!isLastPage) {
      ...
      const everbeeRequest = {
        url: `https://api.everbee.com/product_analytics?type_of_search=&search_term=${term}&order_by=est_mo_revenue&order_direction=desc&est_mo_revenue_min=500&page=${page}&per_page=100`,
        method: 'GET',
        headers: {
